...
class VibesPostgis < Formula
  ...
  conflicts_with 'postgis',
    :because => 'vibes-postgis and postgis install the same binaries.'
  ...
  def install
    ...
    postgres_realpath = Formula["vibes-postgresql"].opt_prefix.realpath
    ...
    (postgres_realpath/'share/vibes-postgresql/extension').install Dir['stage/**/extension/*']
  ...
  def caveats;
    pg = Formula["vibes-postgresql"].opt_prefix
    <<-EOS.undent
